...
def parse_args():
    ...
    parser.add_argument('--logDir',
                        ...
                        type=str,
                        default='runs/')
    parser.add_argument('--weights', nargs='+', type=str, default='/media/database/data4/wjy/projects/YOLOP/tools/runs/BddDataset/_2023-02-22-03-58/epoch-14.pth', help='model.pth path(s)')
